...
public class IdlingResourceMenuActivityTest {
    ...
    // COMPLETE (6) Registers any resource that needs to be synchronized with Espresso before
    // the test is run.
    @Before
    ...
    // COMPLETE (8) Unregister resources when not needed to avoid malfunction
    @After
